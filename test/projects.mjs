...
const projectTemp = mkdtempSync(join(tmpdir(), "lumeri-project-source-"));
const sourceRoot = join(projectTemp, "Source Clips");
...
await command(`/project create New Film --folder ${sourceRoot}`, 500);
assert.deepEqual(createdProjects, [{ name: "New Film", source_root: canonicalSourceRoot }]);
